...
Since SBCL is lacking this and other similar instructions, I want to attempt and make an actual contribution, adding all of them. But itt's going to take some polishing. Did you notice how I casually omitted the `:printer` part of the instruction? Didn't really do it to save space, just hid it because it's not fully done yet.
